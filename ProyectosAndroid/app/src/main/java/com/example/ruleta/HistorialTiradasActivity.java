...
public class HistorialTiradasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbManager.obtenerHistorialDeUsuario(usuarioId)
                ...
                .subscribe(tiradas -> {
                    Log.d("HistorialTiradas", "Tiradas obtenidas correctamente: " + tiradas.size());
                    if (!tiradas.isEmpty()) {
                        ...
                        Toast.makeText(this, "No hay historial de tiradas disponible", Toast.LENGTH_SHORT).show();
                    }
                }, throwable -> {
                    ...
                    Toast.makeText(this, "Error al obtener el historial de tiradas", Toast.LENGTH_SHORT).show();
